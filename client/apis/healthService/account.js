...
console.log('\client\apis\healthService\account', `${healthServer}/account/`)
console.log('\client\apis\healthService\account', request)
console.log('\client\apis\healthService\account', requestAccess)
...
console.log('getAccountApi', getAccountApi)
