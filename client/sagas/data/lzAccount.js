...
// actions
import {
  GET_LZ_ACCOUNT_REQUEST,
  GET_LZ_ACCOUNT_SUCCESS,
  GET_LZ_ACCOUNT_FAILURE,
  UPDATE_LZ_ACCOUNT_HEADIMG_REQUEST,
  UPDATE_LZ_ACCOUNT_HEADIMG_SUCCESS,
  UPDATE_LZ_ACCOUNT_HEADIMG_FAILURE,
  UPDATE_LZ_ACCOUNT_NICKNAME_REQUEST,
  UPDATE_LZ_ACCOUNT_NICKNAME_SUCCESS,
  UPDATE_LZ_ACCOUNT_NICKNAME_FAILURE,
  UPDATE_LZ_ACCOUNT_MOBILE_REQUEST,
  UPDATE_LZ_ACCOUNT_MOBILE_SUCCESS,
  UPDATE_LZ_ACCOUNT_MOBILE_FAILURE,
} from '../../actions/data/lzAccount'
...
import {
  ...
  updateMobileApi,
} from '../../apis/healthService/lzAccount'
